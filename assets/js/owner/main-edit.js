	...
	return new Promise((r, e) => {
		...
		if(loadingBox){
			...
			if(globalSeccion == "politicas"){
				...
				const lista = new Array(document.getElementById("pantallaG"), document.querySelector("nav"));
				gsap.to(lista, {
					duration: 0.8,
					autoAlpha: 1,
...
/*
Funcion para hacer la carga de los recursos primordiales en la primera etapa de inicio del sitio, cargu aqui lo primero que deba de ver el usuario y las funciones mas primordiales y becesarias del sitio.
*/
...
requirejs(["l/modernizr", "l/precarga", "l/brands.min", "l/solid.min", "l/fontawesome", "gsap", "ScrollTrigger", "ScrollToPlugin", "Flip"], controlador);
